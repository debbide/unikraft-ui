    ...
    <form action={action} className="flex flex-wrap items-center gap-3 rounded-md border p-4">
      ...
      <Select name="runtime" defaultValue="base-compat:latest">
        ...
        <SelectContent>
          ...
          <SelectItem value="ghcr.io/cokear/base-compat-debug:latest">Debug 版（排障）</SelectItem>
          <SelectItem value="ghcr.io/cokear/base-compat-strace:latest">Strace 版（系统调用追踪）</SelectItem>
        </SelectContent>
      </Select>
